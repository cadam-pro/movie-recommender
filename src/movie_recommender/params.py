...
CREDIT_URL = "https://api.themoviedb.org/3/movie/{credit_movie_id}/credits?api_key={API_KEY}"
MOVIE_CHANGE_URL = "https://api.themoviedb.org/3/movie/{movie_id}/changes?api_key={API_KEY}"
